...
declare const _default: {
    ...
    'an existing security group can be specified instead of auto-created'(test: Test): void;
    ...
    'can configure maxInstanceLifetime'(test: Test): void;
    'throws if maxInstanceLifetime < 7 days'(test: Test): void;
    'throws if maxInstanceLifetime > 365 days'(test: Test): void;
    'can configure instance monitoring'(test: Test): void;
    'instance monitoring defaults to absent'(test: Test): void;
    ...
    'throw if notification and notificationsTopics are both configured'(test: Test): void;
    'allow configuring notifications'(test: Test): void;
    'notificationTypes default includes all non test NotificationType'(test: Test): void;
    'setting notificationTopic configures all non test NotificationType'(test: Test): void;
    'NotificationTypes.ALL includes all non test NotificationType'(test: Test): void;
};
export = _default;
